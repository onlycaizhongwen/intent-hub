...
- 已提供进程内基础告警快照、Prometheus scrape 配置片段样例、Prometheus Alertmanager 规则样例、Grafana dashboard 样例和 SLO 样例；暂未提供生产化服务发现、TLS/鉴权、Alertmanager route、Grafana folder/provisioning、正式 SLA 和错误预算审批流程。
